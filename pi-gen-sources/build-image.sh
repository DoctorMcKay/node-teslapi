...
curl -L https://nodejs.org/dist/v10.16.0/node-v10.16.0-linux-armv6l.tar.xz > node-v10.16.0-linux-armv61.tar.xz
tar -xf node-v10.16.0-linux-armv61.tar.xz
mv node-v10.16.0-linux-armv61/bin/node ../stage7/00-teslapi-tweaks/files/node
cd ..
rm -rf temp
